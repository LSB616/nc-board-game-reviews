...
const { getReviews, getCategories, getReview, getComments, newComment, editReview } = require('./controllers/board-game-review-controllers')
...
app.post('/api/reviews/:review_id/comments', newComment)
